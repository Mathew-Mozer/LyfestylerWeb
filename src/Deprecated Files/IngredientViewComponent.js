...
import FoodIngredientList from '../Component/FoodIngredientList'
            ...
            <Container fluid>
                <Row>
                    <Col className="border border-info rounded Add-Gutter" sm={4} md={{ size: 2, offset: 1 }} >
                        <Row>
                            <Col><FoodIngredientList ingredients={this.props.ingredients} isLoading={this.props.ingredients.isLoading} errMess={this.props.ingredients.errMess} /></Col>
                        </Row>
                    </Col>
